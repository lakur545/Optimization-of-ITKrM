...
def ImportDataMRI(picType=-1, batchNumber=1):
    """
...
#    pics = ImportData(1)
#    PlotPics(pics)
    [picsMRI,test_picMRI] = ImportDataMRI(1)
    plt.figure('picture 1')
    PlotPics(picsMRI)
    plt.figure('picture 2')
    PlotPics(test_picMRI)
    plt.imshow(test_picMRI, cmap='gray', vmin=0, vmax=255)
