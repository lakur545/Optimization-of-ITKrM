...
def OMP(D, y, e, sparsenesslevel, flag2, timer):
    ...
    #print("x_sparse_sorted", x_sparse_sorted)
...
if __name__ == "__main__":
    ...
    timer = 1 #For the doctest, as it does not work with the timer print

    x_s = OMP(D,y, error, sparsenesslevel, flag, timer)
