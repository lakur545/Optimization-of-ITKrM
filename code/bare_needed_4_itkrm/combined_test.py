...
import Niels_ITKrM
from sequential_optimization_line_profiler.Iteration3 import Niels_ITKrM_optimization
...
dictionary = Niels_ITKrM_optimization.itkrm(smallSet,K,S,maxit) # for the apply_async (nTrainingData)
print("\nOMP")
